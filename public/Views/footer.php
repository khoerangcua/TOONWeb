            ...
            <div class="row no-gutters ftr-background">
                ...
                <div class="col-12 col-sm-12 col-md-12  col-lg-4 col-xl-4 text-center">
                    ...
                    <div class="row" style="text-align: center;">
                        <div class="col" id="ftr-image">
                            <img class="ftr-image" src="public/resource/Logo/logo.png" alt="">
                        </div>



                    </div>
                    <img class="ftr-logo" src="public/resource/Logo/logotxt.png">
                </div>
                <!--right_side-->
                <div class="col-12 col-sm-12 col-md-12  col-lg-8 col-xl-8" style="padding: 0px;">
                    ...
                    <div class="row">
                        <!--bản quyền-->
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <p class="ftr-copyright">© 2022 TOON, Inc. All Rights Reserved</p>
